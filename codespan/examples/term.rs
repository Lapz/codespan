...
use codespan::reporting::term::termcolor::StandardStream;
use codespan::reporting::term::{emit, ColorArg};
use codespan::reporting::{Diagnostic, Label};
use codespan::Files;
...
fn main() {
    ...
    let config = codespan::reporting::term::Config::default();
