...
fn main() {
    ...
    let diagnostics = [
        ...
        Diagnostic::error()
            .with_title(Title::new("`case` clauses have incompatible types").with_code("E0308"))
            .with_labels(vec![
                Label::primary(file_id3, 303..306, "expected `String`, found `Nat`"),
                Label::secondary(file_id3, 186..306, "`case` clauses have incompatible types"),
                Label::secondary(file_id3, 233..243, "this is found to be of type `String`"),
                Label::secondary(file_id3, 259..265, "this is found to be of type `String`"),
                Label::secondary(file_id3, 281..287, "this is found to be of type `String`"),
            ])
            .with_notes(vec![unindent::unindent(
                "
                expected type `String`
